public class EquilateralTriangle extends Shape {
    ...
    public EquilateralTriangle() {
        ...
        if (sideA != sideB && sideB != sideC && sideC != sideA) {
            System.out.println("Error: The sides are not equal.");
            System.exit(1);
        }
    ...
    public EquilateralTriangle(String name, String color, boolean filled, double sideA, double sideB, double sideC) {
